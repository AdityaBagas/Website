...
xmlhttp.open("GET","call_ajax_admin.php?n="+s1,true);
xmlhttp.send();	
}
</script>         
 
<div id="headdown">
	<div class="logo"><a href="indexsearchadmin.php">Logo</a></div>
		<div class="srbox">
		<!-- /////form buat search///// -->
			<form action="details-admin.php" method="get">
			  <div class="bk">
              	<input type="text" onKeyUp="fx(this.value)" autocomplete="off" name="qu" id="qu" class="textbox" placeholder="Cari Kos" tabindex="1">
