		...
		<!-- <div id="body"> -->
			<!-- <div id="logo"> -->
				...
				<div class="container1 bg-light">
					...
					<br><input id="submitlogin" type="submit" name="submitlogin" value="login" />
				</div>
				<div class="container1" style="background-color:#f1f1f1">
					<a href="indexkos.php">
					<button type="button" class="cancelbtn"onclick="window.location.href='indexkos.php'">Cancel</button>
						<br><a href='loginAdmin.php'>Login Admin</a> untuk masuk kehalaman admin
				</div>
				</form>
			<!-- </div>	 -->
			<!-- </div> -->
