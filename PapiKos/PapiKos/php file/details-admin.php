	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6"> 
			 ...
			 <br>
			 <a href = "form_ubah_admin.php?id=<?php echo $detail['idKos'];?>" class = "btn btn-primary">Ubah</a>
			<a href = "form_hapus.php?id=<?php echo $detail['idKos'];?>" class = "btn btn-primary">Hapus</a>
