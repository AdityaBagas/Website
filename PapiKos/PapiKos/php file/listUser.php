	...
	<div class = "container">
		...
		<div class="row">
			...
			<div class="row">
						...
						<?php $ambil = mysqli_query($connect,"SELECT * FROM data_user") or
						die(mysqli_error($connect));  ?>
			<?php while($data=$ambil->fetch_assoc()){?>
				<div class="col-md-4 mx-0.5 p-3">
				<div class="img-thumbnail">

				<img src="uploads/<?php echo $data['upload'] ?>" width="350" height="250">
				<h4 align="center">Nama   : <?php echo $data['name']?></h4>
				
				<h4 align="center">Alamat : <?php echo $data['alamat'] ?></h4>

				<h4 align="center"><a href = "detailUser.php?id=<?php echo $data["id"] ?>"  class ="btn btn-primary">Details</a></h4>
