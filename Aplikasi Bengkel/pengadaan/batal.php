...
<table border="1">
	...
	if(isset($_GET['cari'])){
        ...
        INNER JOIN supplier ON supplier.id_supplier = pengadaan.id_supplier
         ...
         and status_barang = 'belum_selesai'
         ");				
	}else{
		$data = mysqli_query($conn,"SELECT sparepart.nama_sparepart,
        cabang.nama_cabang,
        ...
        INNER JOIN sales ON sales.id_sales = pengadaan.id_sales
        INNER JOIN supplier ON supplier.id_supplier = pengadaan.id_supplier
        where status_barang = 'belum selesai'
        ");		
	}
	...
	<tr>
		...
		<a href=\"deletepengadaan.php?id_pengadaan=$d[id_pengadaan]\">Batalkan Pengadaan</a> | 
		<a href=\"updategudang.php?id_pengadaan=$d[id_pengadaan]\">Update Pengadaan</a>"?></td>;
