                          ...
                          <!-- <div class="field">
                              ...
                              <!-- <div class="col-12 col-md-6">
                                    ...
                                    <div>
                                        ...
                                        <br><input id="password" class="input" type="password" name="password" size="30" placeholder="Password"/> <br>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                    </div>
                                    <!-- </div>
...
<!-- <h1><img src="papikos.png" alt="Logo papikos"></h1>
<section class="contact-area section-padding-100">
<div class="container">
<div class="row justify-content-center">
<div class="col-12 col-md-10 col-lg-8">
				  <form action="edit-proses.php" method="POST" enctype="multipart/form-data">
                      <fieldset class="fieldset"> <br>
                          ...
                          <div class="field">
                              <div class="col-12 col-md-6">
                                    <div class="group">
                                        <input id="name" class="input" type="text" name="name" size="30" /> <br>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
								...
								<div class="col-12 col-md-6">
                                    <div class="group">
                                        <br> <input id="username" class="input" type="text" name="username" size="30" /> <br>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
								...
								<div class="col-12 col-md-6">
                                    <div class="group">
                                        <br> <input id="alamat" class="input" type="text" name="alamat" size="30" /> <br>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
								...
								<div class="col-12 col-md-6">
                                    <div class="group">
                                        <br> <input id="password" class="input" type="password" name="password" size="30" /> <br>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
								...
								<div class="col-12 col-md-6">
                                    <div class="group">
                                        <br> 
											<input type="file" name="upload" id="upload" class="input" size="30"><br>										
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
