    ...
    if(isset($_POST['submit'])) {
       // $id_sparepart = $_POST['id_sparepart'];
        ...
        if( $jumlah == "" ||  $id_costumer == "" ) {
            ...
            mysqli_query($conn, "insert into detil_transaksi (id_sparepart,harga_jual,id_costumer,jumlah,status) values ('$id_sparepart','$harga_jual','$id_costumer','$jumlah','belum selesai')")
            ...
            <br/>";
            <center><font size="20"><a href='kelolasparepart.php'>ya</a></font></center>;
            <br/>
            <center><font size="20"><?php echo "<a href=\"lanjuttransaksi.php?id_costumer=$id_costumer\">tidak</a>  "?></font></center>;
            <?php
        }
    } else {
?>
