    ...
    <div class="modal-wrapper">
      <div class="modal-container">
        ...
        <div class="modal-body">
          <slot name="body">
            <br>Name: <input type="text" v-model="data.name"><br>
            Units: <input type="text" v-model="data.units"><br>
            Price: <input type="text" v-model="data.price"><br>
            <textarea v-model="data.description" placeholder="description"></textarea>
            <span >
              <img :src="data.image" v-show="data.image != null" style:width="180px" height="243px">
