...
while($res = mysqli_fetch_array($result))
{
    ...
    $total_transaksi = $res['total_transaksi'];
    $id_costumer = $res['id_kostumer'];
    $status = $res['status'];
    ...
    if(isset($_POST['submit'])) {
       // $id_sparepart = $_POST['id_sparepart'];
        ...
        if( $bayar < $total_transaksi ) {
            ...
            mysqli_query($conn, "insert into pembayaran_sparepart (id_transaksi,id_pegawai,tanggal_pembayaran,diskon,total,bayar,kembalian) values ('$id_transaksi','$id_pegawai','$tanggal_pembayaran','$diskon','$total_transaksi','$bayar','$bayar-$total_transaksi')")
            ...
            <br/>";
            <center><font size="20"><a href='lihatpembayaran.php'>Go back</a></font></center>;
            <center><font size="20"><?php echo "<a href=\"../transaksi/cetaknota2.php?id_costumer=$id_costumer\">cetak nota</a> | "?></font></center>;
            <?php
        }
    } else {
?>
